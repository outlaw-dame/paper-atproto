...
function hasDangerousControlChars(value) {
    return /[\u0000-\u001F\u007F\u200B-\u200D\uFEFF]/.test(value);
}
export function sanitizeExternalUrl(rawUrl) {
    const trimmed = rawUrl.trim();
    if (!trimmed || hasDangerousControlChars(trimmed))
        return null;
    try {
...
export function getSafeExternalHostname(rawUrl) {
...
//# sourceMappingURL=externalUrl.js.map