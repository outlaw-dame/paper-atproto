...
export function emptyInterpolatorState(rootUri) {
    return {
        rootUri,
        summaryText: '',
        salientClaims: [],
...
export function runInterpolatorPipeline(input) {
 ...
 */
export function extractMedia(node) {
    const media = [];
 ...
 */
export function nodeToThreadPost(node) {
    ...
    const facets = node.facets
        ...
        .map(f => ({
        type: (f.kind === 'hashtag' ? 'tag' : f.kind),
...
//# sourceMappingURL=atprotoInterpolatorAdapter.js.map