function getTitle(mode, state) {
    ...
    if (mode === 'reply') {
        if (state === 'positive')
            return 'Reply context · Constructive signal';
        if (state === 'neutral')
...
function getPositiveMessage(context, heuristics, ml, scores) {
...
function getCautionMessage(context, heuristics, scores) {
    if (context.mode === 'hosted_thread') {
...
function getWarningMessage(context, scores, abuseScore) {
    if (context.mode === 'hosted_thread') {
...
function getAlertMessage(heuristics) {
...
function getNeutralMessage(context) {
    if (context.mode === 'reply') {
...
function getFootnote(state, context) {
    if (state === 'positive') {
...
function getBadges(context, heuristics, scores) {
    const badges = [];
...
function getSuggestion(state, context, scores) {
...
export function buildComposerGuidanceUi(context, heuristics, state, abuseScore, ml, scores) {
