...
// ─── helpers ─────────────────────────────────────────────────────────────
function makeTrigger(kind, replyUri, payload) {
    return {
        kind,
...
export function detectTrigger(existingState, newScores, newRepliesCount, userFeedbackReplyUri) {
...
export function applyTriggerToState(existing, patch, trigger) {
...
//# sourceMappingURL=updateInterpolatorState.js.map