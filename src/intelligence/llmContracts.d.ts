...
export interface WriterContributor {
    ...
    handle: string;
    displayName?: string | undefined;
    role: 'op' | 'clarifier' | 'source-bringer' | 'counterpoint' | 'context-setter' | 'emotional-reaction' | 'rule-source' | 'question-raiser';
    impactScore: number;
...
//# sourceMappingURL=llmContracts.d.ts.map