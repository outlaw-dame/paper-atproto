...
export default function UpdateAvailableBanner() {
    ...
    return (_jsx(AnimatePresence, { children: updateAvailable && (_jsxs(motion.div, { role: "alert", "aria-live": "polite", initial: { opacity: 0, y: -8 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -8 }, transition: { duration: 0.22, ease: [0.25, 0.1, 0.25, 1] }, style: {
                position: 'fixed',
                top: 0,
                left: 0,
                right: 0,
                ...
                fontWeight: 500,
                lineHeight: 1.4,
            }, children: [_jsxs("svg", { "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", style: { flexShrink: 0 }, children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("polyline", { points: "16 12 12 8 8 12" }), _jsx("line", { x1: "12", y1: "16", x2: "12", y2: "8" })] }), _jsx("span", { style: { flex: 1 }, children: "A new version of Glimpse is ready" }), _jsx("button", { onClick: handleUpdate, style: {
                        flexShrink: 0,
                        appearance: 'none',
                    ...
                    }, children: "Update" }), _jsx("button", { onClick: () => setDismissed(true), "aria-label": "Dismiss update notification", style: {
                        flexShrink: 0,
                        background: 'none',
                        border: 'none',
                        cursor: 'pointer',
...
//# sourceMappingURL=UpdateAvailableBanner.js.map