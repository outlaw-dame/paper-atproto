...
const PUSH_SUBSCRIPTION_ENDPOINT = '/api/push/subscription';
...
export async function ensurePushSubscription() {
    ...
    if (!VAPID_PUBLIC_KEY) {
        console.warn('[Push] VITE_VAPID_PUBLIC_KEY not configured — push unavailable.');
        return { ok: false, errorCode: 'unsupported' };
    }
    try {
...
async function removeSubscriptionFromBackend(sub) {
    try {
...
function withFullJitter(base, max, attempt) {
