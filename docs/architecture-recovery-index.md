...
11. [IN PROGRESS] Coordinator runtime extraction around `sessionAssembler.ts`; first pure context snapshot slice is implemented. Follow `docs/coordinator-runtime-extraction-plan.md` for the next slices.
